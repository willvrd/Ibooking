...
@section('style')
    <link rel="stylesheet" type="text/css" href="{{ asset('modules/ibooking/vendor/fancyBox/source/jquery.fancybox.css') }}" media="screen" />
@stop
@section('scripts')
    <script type="text/javascript" src="{{ asset('modules/ibooking/vendor/fancyBox/source/jquery.fancybox.js') }}"></script>
    <script>
